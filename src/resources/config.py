globals = {
	...
	"bluetooth": {
		...
		"reconnection_retries": 5 # Number of retries for Bluetooth reconnection
	},
	"uart": {
	...
	"style": { # Collection of default styles for the application
		"default_app_style", # Default application style
		"default_button_style", # Default button style
		"default_line_edit_style", # Default line edit style
		"default_text_edit_style", # Default text edit style
		"default_ptext_edit_style", # Default plaintext edit style
		"default_tab_style", # Default tab style
		"default_scroll_style" # Default scroll style
	}
}