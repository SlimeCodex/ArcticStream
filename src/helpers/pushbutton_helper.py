...
class ToggleButton(QPushButton):
	def __init__(self, parent=None, icons=None, size=None, style=None, callback=None, toggled=False):
	...
	def setupButton(self):
		...
		icon = self.rendered_icons[icon_id] if self.rendered_icons[icon_id] else QIcon(self.icons[icon_id])
		self.setIcon(icon)
